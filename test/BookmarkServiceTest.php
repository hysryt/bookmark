...
class BookmarkServiceTest {
    public function testNormal() {
        ...
        $bookmark = $bookmarkService->createBookmark('https://qiita.com/');
        ...
        assert($bookmark->getUrl() === 'https://qiita.com/');
    }

    public function testUnreachableUrl() {
        $bookmarkService = new BookmarkService(__DIR__ . '/thumbnail', 200, 200);
        // via https://qiita.com/mocklab/items/5aaa92225fe4c93d0898
        $bookmark = $bookmarkService->createBookmark('https://api-responser.mock-lab.com/');
    ...
    public function testUnsupportType() {
        $bookmarkService = new BookmarkService(__DIR__ . '/thumbnail', 200, 200);
        try {
            $bookmarkService->createBookmark('https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png');
            throw new Exception();
        } catch (Exception $e) {
